...
*/
osThreadId Red_ThreadId, Green_ThreadId; 
osTimerId Blue_TimerThreadId;
...
osTimerDef(BlueTimer, BlueThread);
...
int main(void){
	...
	Blue_TimerThreadId = osTimerCreate(osTimer(BlueTimer), osTimerPeriodic, NULL);
	osTimerStart(Blue_TimerThreadId, 500);
